...
dataset_path = os.path.join(BASE_DIR, '..', '..', 'datasets', 'Iraq', 'data_processed.xlsx')
checkpoint_root_dir = os.path.join(BASE_DIR, 'Iraq', 'checkpoints_saint')
embedding_output_dir = os.path.join(BASE_DIR, 'Iraq', 'embeddings_saint')
...
for embed_dim in embedding_sizes:
    ...
    with torch.no_grad():
        for batch in full_loader:
            ...
            embeddings = model.get_embeddings(x_categ, x_num, x_categ_enc, x_cont_enc)
