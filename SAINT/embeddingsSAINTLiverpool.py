...
# Adjust the path to SAINT model
...
checkpoint_root_dir = os.path.join(BASE_DIR, 'Liverpool', 'checkpoints_saint')
...
# All features including 'sex' are continuous
...
print("\n🎯 All SAINT embeddings generated successfully.")
