...
embedding_output_dir = os.path.join(BASE_DIR, 'embeddings_classical_reduction', 'CBC', 'v1.2')
...
class VariationalAutoencoder(nn.Module):
    def __init__(self, input_dim, latent_dim):
        ...
        self.decoder = nn.Sequential(
            ...
            nn.Linear(64, 128),
            nn.ReLU(),
            nn.Linear(128, input_dim)  # No activation here
        )
...
# reduction_dims = [16, 20] decreasing the dimensions to have better KL value
reduction_dims = [8, 12]
...
for dim in reduction_dims:
    ...
    # beta = 4.0 increasing the beta value to have better KL values
    beta = 10.0
