...
num_cols = [
    ...
    'eosinophil_count', 'basophil_count', 'red_blood_cells', 'hemoglobin', 'hematocrit',
    'mean_corpuscular_volume', 'mean_corpuscular_hemoglobin', 'mean_corpuscular_hemoglobin_concentration',
    'red_cell_distribution_width', 'platelets', 'mean_platelet_volume', 'plateletcrit',
    'platelet_distribution_width', 'SD', 'SDTSD', 'TSD', 'ferritin', 'folate', 'vitamin_b12'
]
bin_cols = ['gender']
...
for dim in reduction_dims:
    ...
    if dim >= X.shape[1]:
        raise ValueError(f"⚠️ Dimension {dim} must be less than input dimension {X.shape[1]}")
    ...
    with open(log_path, 'w') as log_file:
        ...
        for epoch in range(50):
            ...
            for batch in loader:
                ...
                loss, recon_loss, kl_loss = vae_loss(recon, x_batch, mu, logvar, beta)
...
print("\n✅ All dimensionality reduction embeddings saved successfully.")
