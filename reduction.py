...
for method in methods:
    ...
    for dataset in datasets:
        ...
        for dim in dim_map[dataset]:
            ...
            embed_path = os.path.join(BASE_DIR, dataset, f'{method.lower()}_embeddings_{dim}d.npy')
            id_path = os.path.join(BASE_DIR, dataset, f'{method.lower()}_row_indices_{dim}d.npy')
