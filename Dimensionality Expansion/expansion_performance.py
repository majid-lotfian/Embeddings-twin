...
#methods = ['polyexpand', 'randomproj', 'vae']
methods = ['polyexpand']
...
for method in methods:
    print(f"\n🔵 Evaluating embeddings for method: {method}")
    for dataset in datasets:
        ...
        for dim in dim_map[dataset]:
            ...
            embed_path = os.path.join(BASE_DIR, dataset, f'{method}_embeddings_{dim}d.npy')
            id_path = os.path.join(BASE_DIR, dataset, f'{method}_row_indices_{dim}d.npy')
...
print("\n✅ All expansion evaluations completed.")
