...
embedding_output_dir = os.path.join(BASE_DIR, 'Covid19', 'embeddings_fttransformer')
...
# Store row identifiers and remove 'id' from features
ids = data['id'].values
...
bin_cols = ['sex']  # encoded from 'male'/'female' to 0/1
...
for embed_dim in embedding_sizes:
    ...
    for epoch in range(50):
        ...
        for batch in train_loader:
            ...
            loss = criterion(outputs, torch.zeros_like(outputs))  # stability pretraining
